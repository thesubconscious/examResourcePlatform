    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/courses/{id}").hasAnyAuthority("teacher")
                        .requestMatchers(HttpMethod.DELETE, "/courses/{id}").hasAnyAuthority("teacher")
                        .requestMatchers(HttpMethod.POST, "/courses/{courseId}/resources").hasAnyAuthority("teacher")
                        .requestMatchers(HttpMethod.DELETE, "/courses/{courseId}/resources/{resourceId}").hasAnyAuthority("teacher")
